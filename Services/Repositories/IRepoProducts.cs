    ...
    public class IRepoProducts
    {
        ...
        new ProductVM()
        {
            ...
            if (Parameters.MinPrice != null)
            {
                ...
                ListOfSelectedFilters.Add(new AppliedFilters(propartyName: nameof(Parameters.MinPrice), Parameters.MinPrice?.ToString() ?? ""));
            ...
            if (Parameters.MaxPrice != null)
            {
                ...
                ListOfSelectedFilters.Add(new AppliedFilters(propartyName: nameof(Parameters.MaxPrice), Parameters.MaxPrice?.ToString() ?? ""));
            ...
            if (!string.IsNullOrEmpty(Parameters.SearchTearm))
            {
                ...
                ListOfSelectedFilters.Add(new AppliedFilters(propartyName: nameof(Parameters.SearchTearm), Parameters.SearchTearm?.ToString() ?? ""));
            ...
            if (!string.IsNullOrEmpty(Parameters.Title))
            {
                ...
                ListOfSelectedFilters.Add(new AppliedFilters(propartyName: nameof(Parameters.Title), Parameters.Title?.ToString() ?? ""));
