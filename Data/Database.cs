namespace liaqati_master.Data
{
    public static class Database
    {
        ...
        public static string ManagerPolicy => "ManagerPolicy";
        ...
        public static List<string> AppClaimTypes = new()
        {
            Admin,
            Expert,
            User,
...
نصائح رمضانية*/
      ...
      new SelectListItem() {
        ...
        new HealthyRecipe {
          Id = "41", Title = "",
            Image = "/images/HealthyRecipes/1.jpg", MealType = MealTypeTypeStatus.Dinner.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 50, Calories = 491, Total_Carbohydrate = 43, Protein = 35
        },
        //الثوم الطازج والليمون,سمك السلمون,طماطم كرزية,صلصة 
        new HealthyRecipe {
          Id = "42", Title = "",
            Image = "/images/HealthyRecipes/2.jpg", MealType = MealTypeTypeStatus.Snack.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 5, Calories = 156, Total_Carbohydrate = 17, Protein = 4
        },
        //موزولوز
        new HealthyRecipe {
          Id = "43" ,Title = "",  Image = "/images/HealthyRecipes/3.jpg", MealType = MealTypeTypeStatus.Lunch.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 50, Calories = 379, Total_Carbohydrate = 47, Protein = 32
        },
        // الدجاج المشويةوصلصة الباربكيو و وتوابل الصوديوم المنخفضةوالسكروالطماطم و شريحتين من خبز القمح الكامل المحمص و خل التفاح
        new HealthyRecipe {
          Id = "44",Title = "",  Image = "/images/HealthyRecipes/4.jpg", MealType = MealTypeTypeStatus.Snack.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 60, Calories = 19, Total_Carbohydrate = 37, Protein = 5
        },
        ...
        new HealthyRecipe {
          Id = "45",Title = "",  Image = "/images/HealthyRecipes/5.png", MealType = MealTypeTypeStatus.Snack.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 60, Calories = 170, Total_Carbohydrate = 43, Protein = 5
        },
        ...
        new HealthyRecipe {
          Id = "46", Title = "", Image = "/images/HealthyRecipes/6.jpg", MealType = MealTypeTypeStatus.Lunch.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 30, Calories = 180, Total_Carbohydrate = 44, Protein = 4
        },
        ...
        new HealthyRecipe {
          Id = "47", Title = "", Image = "/images/HealthyRecipes/7.jpg", MealType = MealTypeTypeStatus.Dinner.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 35, Calories = 538, Total_Carbohydrate = 79, Protein = 37
        },
        //صدور الدجاج والجلد,الأرز البني, زبادي يوناني قليل الدسم ,الثوم, فتات خبز القمح الكامل المقرمش,طبقة البارميزان,
        new HealthyRecipe {
          Id = "48", Title = "", Image = "/images/HealthyRecipes/8.jpg", MealType = MealTypeTypeStatus.Breakfast.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 10, Calories = 30, Total_Carbohydrate = 10, Protein = 5
        },
        //50 جرام بقدونس,1الليمون,1الخيار, 1التفاح,20 جرام النعناع
        new HealthyRecipe {
          Id = "49",    Title = "", Image = "/images/HealthyRecipes/9.png", MealType = MealTypeTypeStatus.Breakfast.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 15, Calories = 110, Total_Carbohydrate = 10, Protein = 5,
        },
        //ربع ملعقةزيت زيتون,1فلفل, ربع كوبزيتون, رشةفلفل اسود, قطعةريكفورد
        new HealthyRecipe {
          Id = "50",Title = "",  Image = "/images/HealthyRecipes/10.png", MealType = MealTypeTypeStatus.SideDish.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 60, Calories = 40, Total_Carbohydrate = 20, Protein = 8
        },
        //1جزر, 1 خرشوف,100 جرامكوسة,100 جرامذرة حب,ربع ملعقة نشأ, 1 بطاطس,100 جرامبسلة,100 جرامفاصوليا, نصف كوب لبن, ملعقة دقيق
        new HealthyRecipe {
          Id = "51",Title = "",  Image = "/images/HealthyRecipes/11.png", MealType = MealTypeTypeStatus.Lunch.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 50, Calories = 125, Total_Carbohydrate = 30, Protein = 5,
        },
        ...
        new HealthyRecipe {
          Id = "52",Title = "",  Image = "/images/HealthyRecipes/12.png", MealType = MealTypeTypeStatus.Snack.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 30, Calories = 66, Total_Carbohydrate = 36, Protein = 5,
        },
        ...
        new HealthyRecipe {
          Id = "53",Title = "",  Image = "/images/HealthyRecipes/13.jpg", MealType = MealTypeTypeStatus.Lunch.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 30, Calories = 110, Total_Carbohydrate = 45, Protein = 7,
        },
        //250 جرام دجاج,2فلفل الوان,1بصلة,ملعقتين صلصلة صحية,100 جراممكرونة
        new HealthyRecipe {
          Id = "54",Title = "",  Image = "/images/HealthyRecipes/14.jpg", MealType = MealTypeTypeStatus.Lunch.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 60, Calories = 145, Total_Carbohydrate = 30, Protein = 17,
        },
        ...
        new HealthyRecipe {
          Id = "55",Title = "",  Image = "/images/HealthyRecipes/15.png", MealType = MealTypeTypeStatus.SideDish.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 15, Calories = 25, Total_Carbohydrate = 10, Protein = 8
        },
        ...
        new HealthyRecipe {
          Id = "56", Title = "", Image = "/images/HealthyRecipes/16.jpg", MealType = MealTypeTypeStatus.Snack.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 30, Calories = 150, Total_Carbohydrate = 25, Protein = 5
        },
        // نصف لتر لبن,4 باكيتسكر دايت,2 ملعقةجوز الهند,2 ملعقة ماء ورد,ملعقةنشا,1فانيليا
        new HealthyRecipe {
          Id = "57",Title = "",  Image = "/images/HealthyRecipes/17.jpg", MealType = MealTypeTypeStatus.Dinner.ToString(), DietaryType = DietaryTypeStatus.Vegetarian.ToString(), PrepTime = 20, Calories = 50, Total_Carbohydrate = 15, Protein = 4
        },
        //1ملفوف,1جزر,3المايونيز الصحي,1زبادي كبير,ملعقة صغيرة عسل ابيض,3 ملعقاتخل,ربع ملعقةملح
        new HealthyRecipe {
          Id = "58",Title = "",  Image = "/images/HealthyRecipes/18.jpg", MealType = MealTypeTypeStatus.Breakfast.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 30, Calories = 65, Total_Carbohydrate = 40, Protein = 15
        },
        //1بصلة,300 جراملحمة المفرومة,1بيضة, رشة فلفل أسمر,ملعقتانزيت,ملعقةبصل بودر,حسب الرغبةبهارات,حسب الرغبةبقدونس
        new HealthyRecipe {
          Id = "59",Title = "",  Image = "/images/HealthyRecipes/19.jpg", MealType = MealTypeTypeStatus.Breakfast.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 15, Calories = 34, Total_Carbohydrate = 15, Protein = 0
        },
        // ملعقةسكر دايت,1تفاح,2القرنفل ,عودالقرفة
        new HealthyRecipe {
          Id = "60",Title = "",  Image = "/images/HealthyRecipes/20.jpg", MealType = MealTypeTypeStatus.Breakfast.ToString(), DietaryType = DietaryTypeStatus.Omnivore.ToString(), PrepTime = 240, Calories = 45, Total_Carbohydrate = 15, Protein = 7
        },
