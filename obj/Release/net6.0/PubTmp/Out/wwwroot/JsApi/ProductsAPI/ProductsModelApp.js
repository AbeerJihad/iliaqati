                ...
                <div>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold text-danger m-0">${formatter.format(Product.price)}</h5>
                     <a href="/Cart/Cart" title="إضافة إلى السلة" onclick="addprotocart('${Product.id}')" class="rounded-pill btn imgBackground add-to-bag-btn border shadow-sm rounded d-flex fw-bold justify-content-center align-items-center align-middle">
