        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewsNumber = table.Column<int>(type: "int", nullable: false),
                    Ingredients = table.Column<string>(type: "NTEXT", nullable: false),
                    PreparationMethod = table.Column<string>(type: "NTEXT", nullable: false),
                    RatePercentage = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, false, "5a1d2db1-c22a-48ea-82bb-bf0be59c9d51", null, null, false, 10, "sssssssssssssss", 1, 120, null, "sssssssssssssss", false, null, null, null, null, null, false, "ssssssssssssssss", "dfd7cdb8-db71-4383-b371-f8a64d854482", null, null, false, null, null, 120 },
                    { "cadcdb03-ee31-4652-a8b5-9a9ace656e8f", 0, null, "469c4a41-9444-4fc3-95b1-60ae9f9cc2b4", null, "user@example.com", true, null, "عمر", 1, null, null, "حمد", false, null, "USER@EXAMPLE.COM", "USER@EXAMPLE.COM", "AQAAAAEAACcQAAAAEPBRh4n0xrbh9bRschlDaYKMmHkujr+FgpiEjWMlRf/DfmxUU2fkLZejT/paU1HBdA==", "+111111111111", true, null, "dcdf5590-ef27-428a-8d93-b9d200bb9498", null, null, false, "user@example.com", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7861), null, "طبق رئيسي", "الوصفات الصحية" },
                    { "10", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7971), null, "رياضة", "المنتجات" },
                    { "11", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7975), null, "مرض السكري", "المنتجات" },
                    { "12", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7978), null, "شرب المياة", "المنتجات" },
                    { "13", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7981), null, "لياقة بدنية", "استشارات" },
                    { "14", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7985), null, "تغذية", "استشارات" },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7886), null, "أكل صحي", "الوصفات الصحية" },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7891), null, "المكملات الغذائية", "المنتجات" },
                    { "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7899), null, "الاجهزة الرياضية", "المنتجات" },
                    { "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7953), null, "حلوى", "الوصفات الصحية" },
                    { "6", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7959), null, "الأنظمة الحديثة", "الأنظمة الرياضية" },
                    { "8", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7963), null, "عامة", "المنتجات" },
                    { "9", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7966), null, "الصيام المتقطع", "المقالات" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "10", "14", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8532), "أنا فتاة عمري 24 عاما, أعاني من نقص الوزن, وأريد أن يزيد وزني، جربت بعض الأدوية ولكن لم أر أي فائدة, مع العلم أنني لا أشكو من أي مرض والحمد لله.\r\n\r\nوزني 41 كيلو, وطولي 150 سم, سمعت عن حبوب اسمها سبروفيتا (cypro-vita)\r\nما رأيكم فيها؟ وهل لها أضرار؟\r\n", "هل دواء سبروفيتا ناجع لزيادة الوزن؟", "1", 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8415), "61", "/Images/HealthyRecipes/1.jpg", null },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8418), "61", "/Images/HealthyRecipes/img61.jpg", null },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8419), "61", "/Images/HealthyRecipes/im61.jpg", null },
                    { "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8420), "62", "/Images/HealthyRecipes/2.jpg", null },
                    { "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8420), "62", "/Images/HealthyRecipes/img62.jpg", null },
                    { "6", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8422), "62", "/Images/HealthyRecipes/im62.jpg", null },
                    { "7", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8422), "66", "/user/images/pexels-toni-cuenca-616833.png", null },
                    { "8", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8423), "66", "~/user/images/224347.png", null },
                    { "9", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8423), "66", "/user/images/224664.png", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8584), new DateTime(2023, 5, 25, 0, 0, 0, 0, DateTimeKind.Local), "في قاموس المعاني الفوري مجال البحث مصطلحاتى", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " اشعار 1", "1" },
                    { "10", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8604), new DateTime(2022, 9, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار7", "1" },
                    { "11", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8605), new DateTime(2021, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار7", "1" },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8590), new DateTime(2023, 5, 25, 0, 0, 0, 0, DateTimeKind.Local), "في قاموس المعاني الفوري مجال البحث مصطلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على سسسسس", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار 2", "1" },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8592), new DateTime(2023, 5, 25, 0, 0, 0, 0, DateTimeKind.Local), "في قاموس المعاني الفوري مجال البحث مصطلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " اشعار 3", "1" },
                    { "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8593), new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار4", "1" },
                    { "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8596), new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار5", "1" },
                    { "6", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8599), new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار6", "1" },
                    { "7", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8600), new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار7", "1" },
                    { "8", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8601), new DateTime(2023, 5, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار6", "1" }
                });

            migrationBuilder.InsertData(
                table: "TblNotification",
                columns: new[] { "Id", "CreatedDate", "DATE", "Text", "Time", "Title", "UserId" },
                values: new object[] { "9", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8602), new DateTime(2023, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "طلحات الكل ضمن قاموس عربي عربي. معجم شامل يحوي على ممم", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اشعار7", "1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7676), "#15ar12", new DateTime(2021, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 3400.0, "1" },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7743), "#13da32", new DateTime(2021, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 4500.0, "1" },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7806), "#47as32", new DateTime(2021, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 5900.0, "1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8017), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 19.989999999999998, 20.0, null, "أسبوع من المرح وتدريب مكثف للجزء السفلي من الجسم وبناء القوة في العضلات و أوتار الركبة", null },
                    { "100", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8010), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 350.0, null, null, "4أسابيع من المرح وتدريب مكثف للجزء السفلي من الجسم وبناء القوة في العضلات و أوتار الركبة", null },
                    { "101", "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8014), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 100.0, null, null, "تحدي للياقة البدنية لمدة 5 أيام مجانًا", null },
                    { "102", "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8015), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 200.0, null, null, "3 تمارين في الأسبوع لمدة أسبوعين", null },
                    { "103", "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8016), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 450.0, 30.0, null, "برنامج لمدة 8 أسابيع لبدء روتين لياقتك البدنيةتدريبات صديقة للمبتدئين لبناء القوة والثقة والاتساق", "1" },
                    { "11", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8048), "يعتمد على تناول البقوليات و المكسرات و الأوراق الخضراء ,مفيد لمرضى السكر و القلب ", null, false, false, 19.989999999999998, null, null, " اختبار ", null },
                    { "2", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8019), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 20.989999999999998, 20.0, null, "أسبوع من المرح وتدريب مكثف للجزء السفلي من الجسم وبناء القوة في العضلات و أوتار الركبة", null },
                    { "21", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8049), "", null, false, false, 20.0, null, null, "طقم اوزان دمبل 30 كغم", null },
                    { "22", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8050), "", null, false, false, 30.0, null, null, "حلقات لايف اب الاولمبية للجمباز", null },
                    { "23", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8051), "", null, false, false, 1490.0, null, null, "مشاية كهربائية منحنية بدون محرك", null },
                    { "24", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8052), "", null, false, false, 320.0, null, null, "دراجة سبينر", null },
                    { "25", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8053), "", null, false, false, 150.0, null, null, "Livepro أيروبيك ستيبر ومقعد", null },
                    { "26", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8054), "", null, false, false, 15.0, null, null, "سجادة Liveup للتمارين الرياضية", null },
                    { "27", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8055), "", null, false, false, 175.0, null, null, "مقعد بووفليكس متعدد الوظائف", null },
                    { "28", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8056), "", null, false, false, 69.0, null, null, "حبل معركة بروبانتل", null },
                    { "29", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8057), "", null, false, false, 125.0, null, null, "مقعد قابل للطي قابل للتعديل للتمارين الرياضية", null },
                    { "3", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8021), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 19.989999999999998, 20.0, null, "أسبوع من المرح وتدريب مكثف للجزء السفلي من الجسم وبناء القوة في العضلات و أوتار الركبة", null },
                    { "30", "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8058), "", null, false, false, 25.0, null, null, "مجدّف", null },
                    { "31", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8059), "", null, false, false, 111.0, null, null, "زيت السمك أوميغا 3", null },
                    { "32", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8060), "", null, false, false, 78.0, null, null, "Muscletech, بلاتينيوم ملتي فيتامين", null },
                    { "33", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8060), "", null, false, false, 169.0, null, null, "Ultima Replenisher", null },
                    { "34", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8061), "", null, false, false, 169.0, null, null, "زيت الكريل", null },
                    { "35", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8062), "", null, false, false, 170.0, null, null, "أنافيت", null },
                    { "36", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8063), "", null, false, false, 79.0, null, null, "Trace Minerals Research", null },
                    { "37", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8064), "", null, false, false, 109.0, null, null, "BodyBio, E-Lyte", null },
                    { "38", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8064), "", null, false, false, 163.0, null, null, "فيجا ، سبورت", null },
                    { "39", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8065), "", null, false, false, 111.0, null, null, "مضاعف الترطيب", null },
                    { "4", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8022), "أضف تحدي الـ 5 أيام هذا إلى تقويم التمرين حيث يمكنك إعادة الجدولة ووضع علامة مكتمل ، تمامًا مثل أحد برامجنا. إذا كنت تستمتع بهذا التحدي ، تحقق من FB Strong الجديدلمدة 4 أسابيع والذي تم إطلاقهللتو. يستخدم نفس موضوع التحدي (قوي) ويستخدم تمرينًا إضافيًا فريدًاكل يوم (بدون تكرارالتدريبات!).نحن على وشك الوصول إلى مرحلة ممتعة ؛ هذا الأسبوع ، سيصل FitnessBlender رسميًا إلى إجمالي 1000مقطع فيديو تمرين ! وهذا الرقم لا يزال يرتفع بسرعة. إذا كنت تستمتعبمقاطع الفيديو الخاصة بالتمرين وتحدي الـ 5 أيام هذا ، فيرجى التفكير في مساعدتنا على الاستمرار في القيام بما نقوم به من خلالمشاركة عملنا مع الأصدقاء والعائلة. نحن لا نقوم بالإعلان على الإطلاق، من أجل المساعدة في الحفاظعلى أسعارنا منخفضة ، لذا فإن الحديث الشفهي مهم بالنسبة لنا. بغض النظر عن طريقة استخدامك لعملنا ،فنحن ممتنون للأشخاص حول العالم الذين يستخدمون Fitness Blenderويسعدنا حقًا وجودك هنا.", null, false, false, 19.989999999999998, 20.0, null, "أسبوع من المرح وتدريب مكثف للجزء السفلي من الجسم وبناء القوة في العضلات و أوتار الركبة", null },
                    { "40", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8066), "", null, false, false, 54.0, null, null, "NutriBiotic", null },
                    { "41", "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8067), "", null, false, false, 169.0, null, null, "زيت الكريل", null },
                    { "5", "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8023), "يعتمد على تناول البقوليات و المكسرات و الأوراق الخضراء ,مفيد لمرضى السكر و القلب ", null, false, false, 19.989999999999998, null, null, " اختبار ", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8425), null, "/user/images/224664.png", "23" },
                    { "11", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8425), null, "/user/images/224664.png", "23" },
                    { "12", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8426), null, "/Images/Product/Dumbbell3.jfif", "22" },
                    { "13", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8427), null, "/user/images/224664.png", "22" },
                    { "14", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8427), null, "/user/images/224664.png", "21" },
                    { "15", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8428), null, "/user/images/224664.png", "21" },
                    { "20", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8429), null, "/Images/Product/LiveupOlympic.jpg", "21" },
                    { "21", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8429), null, "/Images/Product/Curved.jpg", "23" },
                    { "24", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8430), null, "/Images/Product/Dumbbell.jfif", "21" },
                    { "25", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8431), null, "/Images/Product/Dumbbell1.jfif", "21" },
                    { "26", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8432), null, "/Images/Product/Dumbbell3.jfif", "21" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 13.0, "50-250", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8090), "اكلة اللحوم", "Images/MealPlan/1.jpg", 1, "الإفطار والغداء والعشاء والوجبات الخفيفة\r\n", 105 },
                    { "2", 13.0, "50-250", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8095), "اكلة اللحوم", "Images/MealPlan/2.jpg", 1, "الإفطار والغداء والعشاء والوجبات الخفيفة\r\n", 105 },
                    { "3", 20.0, "50-250", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8096), "اكلة اللحوم", "Images/MealPlan/3.jpg", 1, "الإفطار والغداء والعشاء والوجبات الخفيفة\r\n", 105 },
                    { "4", 20.0, null, new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8097), "اكلة اللحوم", "Images/MealPlan/4.jpg", 1, "الإفطار والغداء والعشاء والوجبات الخفيفة\r\n", 105 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8111), "1", 100.0, 2, 1, "21" },
                    { "10", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8120), "1", 100.0, 2, 1, "23" },
                    { "11", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8120), "1", 100.0, 2, 1, "23" },
                    { "12", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8145), "1", 100.0, 3, 1, "23" },
                    { "13", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8147), "2", 100.0, 7, 1, "24" },
                    { "14", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8148), "2", 100.0, 5, 1, "24" },
                    { "15", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8148), "2", 100.0, 3, 1, "24" },
                    { "16", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8149), "3", 100.0, 4, 1, "24" },
                    { "17", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8150), "3", 100.0, 4, 1, "24" },
                    { "18", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8151), "3", 100.0, 10, 1, "24" },
                    { "19", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8152), "1", 100.0, 5, 1, "31" },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8113), "1", 100.0, 2, 1, "21" },
                    { "20", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8153), "1", 100.0, 6, 1, "31" },
                    { "21", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8153), "1", 100.0, 10, 1, "31" },
                    { "22", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8154), "2", 100.0, 7, 1, "31" },
                    { "23", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8155), "2", 100.0, 5, 1, "32" },
                    { "24", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8156), "2", 100.0, 3, 1, "32" },
                    { "25", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8157), "3", 100.0, 11, 1, "32" },
                    { "26", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8157), "3", 100.0, 4, 1, "32" },
                    { "27", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8158), "3", 100.0, 10, 1, "32" },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8113), "1", 100.0, 2, 1, "21" },
                    { "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8114), "2", 100.0, 7, 1, "31" },
                    { "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8115), "2", 100.0, 5, 1, "31" },
                    { "6", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8116), "2", 100.0, 3, 1, "24" },
                    { "7", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8117), "3", 100.0, 2, 1, "23" },
                    { "8", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8118), "3", 100.0, 4, 1, "23" },
                    { "9", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8118), "3", 100.0, 10, 1, "23" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "21", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7582), 20.0, "/Images/Product/Dumbbell3.jfif" },
                    { "22", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7586), 0.0, "/Images/Product/LiveupOlympic.jpg" },
                    { "23", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7587), 0.0, "/Images/Product/Curved.jpg" },
                    { "24", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7588), 0.0, "/Images/Product/Spinner.jpg" },
                    { "25", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7589), 0.0, "/Images/Product/Liveup.jpg" },
                    { "26", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7592), 0.0, "/Images/Product/LiveupOlympic.jpg" },
                    { "27", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7592), 0.0, "/Images/Product/Bowflex.jpg" },
                    { "28", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7593), 0.0, "/Images/Product/Brobantle.jfif" },
                    { "29", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7594), 0.0, "/Images/Product/Adjustable.jpg" },
                    { "30", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7595), 0.0, "/Images/Product/rower.jpg" },
                    { "31", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7596), 0.0, "/Images/Product/omega.jpg" },
                    { "32", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7643), 0.0, "/Images/Product/Muscletech.jpg" },
                    { "33", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7644), 0.0, "/Images/Product/Ultima.jpg" },
                    { "34", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7644), 0.0, "/Images/Product/krilloil.jpg" },
                    { "35", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7645), 0.0, "/Images/Product/anavite.jpg" },
                    { "36", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7645), 0.0, "/Images/Product/Trace.jpg" },
                    { "37", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7646), 0.0, "/Images/Product/BodyBio.jpg" },
                    { "38", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7648), 0.0, "/Images/Product/Vega.jpg" },
                    { "39", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7648), 0.0, "/Images/Product/HydrationMultiplier.jpg" },
                    { "40", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7649), 0.0, "/Images/Product/NutriBiotic.jpg" },
                    { "41", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(7649), 0.0, "/Images/Product/krilloil.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8199), 1, "1", "102", 1 },
                    { "10", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8211), 7, "10", "102", 1 },
                    { "11", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8211), 1, "10", "102", 2 },
                    { "12", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8212), 2, "8", "102", 2 },
                    { "13", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8213), 2, "6", "102", 2 },
                    { "14", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8214), 3, "5", "102", 2 },
                    { "15", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8215), 4, "4", "102", 2 },
                    { "16", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8215), 5, "3", "102", 2 },
                    { "17", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8216), 6, "2", "102", 2 },
                    { "18", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8217), 7, "1", "102", 2 },
                    { "19", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8218), 7, "9", "102", 2 },
                    { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8203), 2, "2", "102", 1 },
                    { "20", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8219), 1, "10", "100", 1 },
                    { "21", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8220), 2, "8", "100", 1 },
                    { "22", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8220), 2, "6", "100", 1 },
                    { "23", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8222), 3, "5", "100", 1 },
                    { "24", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8223), 4, "4", "100", 1 },
                    { "25", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8224), 5, "3", "100", 1 },
                    { "26", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8224), 6, "2", "100", 1 },
                    { "27", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8225), 6, "1", "100", 1 },
                    { "28", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8226), 7, "9", "100", 1 },
                    { "29", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8227), 1, "7", "100", 2 },
                    { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8204), 3, "3", "102", 1 },
                    { "30", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8227), 1, "8", "100", 2 },
                    { "31", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8228), 2, "6", "100", 2 },
                    { "32", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8229), 3, "3", "100", 2 },
                    { "33", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8229), 4, "2", "100", 2 },
                    { "34", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8231), 5, "9", "100", 2 },
                    { "35", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8232), 6, "6", "100", 2 },
                    { "36", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8233), 7, "3", "100", 2 },
                    { "37", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8233), 7, "1", "100", 2 },
                    { "38", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8234), 1, "10", "100", 3 },
                    { "39", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8235), 2, "8", "100", 3 },
                    { "4", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8204), 4, "4", "102", 1 },
                    { "40", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8236), 3, "6", "100", 3 },
                    { "41", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8239), 3, "4", "100", 3 },
                    { "42", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8239), 4, "5", "100", 3 },
                    { "43", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8240), 4, "9", "100", 3 },
                    { "44", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8241), 5, "6", "100", 3 },
                    { "45", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8266), 6, "3", "100", 3 },
                    { "46", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8268), 7, "1", "100", 3 },
                    { "47", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8269), 1, "2", "100", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "48", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8270), 2, "6", "100", 4 },
                    { "49", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8271), 3, "5", "100", 4 },
                    { "5", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8205), 4, "5", "102", 1 },
                    { "50", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8271), 3, "4", "100", 4 },
                    { "51", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8272), 4, "9", "100", 4 },
                    { "52", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8273), 4, "8", "100", 4 },
                    { "53", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8274), 5, "3", "100", 4 },
                    { "54", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8274), 6, "7", "100", 4 },
                    { "55", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8275), 7, "10", "100", 4 },
                    { "56", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8276), 1, "1", "101", 1 },
                    { "57", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8277), 2, "3", "101", 1 },
                    { "58", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8277), 3, "5", "101", 1 },
                    { "59", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8278), 4, "4", "101", 1 },
                    { "6", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8207), 5, "6", "102", 1 },
                    { "60", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8279), 4, "9", "101", 1 },
                    { "61", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8280), 5, "8", "101", 1 },
                    { "62", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8280), 5, "2", "101", 1 },
                    { "63", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8281), 6, "7", "101", 1 },
                    { "64", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8282), 7, "10", "101", 1 },
                    { "65", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8282), 1, "1", "103", 1 },
                    { "66", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8284), 2, "3", "103", 1 },
                    { "67", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8285), 3, "5", "103", 1 },
                    { "68", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8286), 4, "4", "103", 1 },
                    { "69", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8286), 4, "9", "103", 1 },
                    { "7", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8208), 6, "7", "102", 1 },
                    { "70", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8287), 5, "8", "103", 1 },
                    { "71", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8288), 5, "2", "103", 1 },
                    { "72", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8289), 6, "7", "103", 1 },
                    { "73", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8289), 7, "10", "103", 1 },
                    { "8", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8209), 7, "8", "102", 1 },
                    { "9", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8209), 7, "9", "102", 1 }
                });

            migrationBuilder.InsertData(
                table: "TblTracking",
                columns: new[] { "Id", "CreatedDate", "Exercies_programId", "Iscomplete", "Order_DetailsId" },
                values: new object[] { "1", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8178), "1", true, "1" });

            migrationBuilder.InsertData(
                table: "TblTracking",
                columns: new[] { "Id", "CreatedDate", "Exercies_programId", "Iscomplete", "Order_DetailsId" },
                values: new object[] { "2", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8181), "12", false, "1" });

            migrationBuilder.InsertData(
                table: "TblTracking",
                columns: new[] { "Id", "CreatedDate", "Exercies_programId", "Iscomplete", "Order_DetailsId" },
                values: new object[] { "3", new DateTime(2023, 5, 25, 1, 49, 55, 798, DateTimeKind.Local).AddTicks(8181), "13", true, "1" });
